    ...
    private static getSimulationMenu(): MenuItemConstructorOptions {
        return {
            ...
            submenu: [
                ...
                {
                    label: 'Grow Scenario Infrastructure...',
                    click() {
                        WindowManager.createPopupWindowWithRouting({
                            width: 600,
                            height: 500,
                            title: 'Grow Scenario Infrastructure',
                            url: `#/headless/menu/simulation/grow-scenario`,
                        });
                    },
                },
                {
                    label: 'Wire Scenario Parameters...',
                    click() {
                        WindowManager.createPopupWindowWithRouting({
                            width: 600,
                            height: 600,
                            title: 'Wire Scenario Parameters',
                            url: `#/headless/menu/simulation/wire-scenario`,
                        });
                    },
                },
            ],
